...
public class Lanchonete {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%nBEBIDAS:%n%nLATA:%n1 - Sprite R$ 4,00 %n2 - Pepsi R$ 4,00%n3 - Guaraná R$ 4,50 %n4 - Fanta R$ 4,50 %n5 - Coca-Cola R$ 5,00%n%nLITRO:%n1 - Guaraná R$ 5,00%n2 - Coca-Cola R$ 6,00%n3 - Sprite R$ 5,00%n4 - Pepsi R$ 4,50%n5 - Fanta R$ 5,00%n%n");
		
		System.out.printf("PRONTOS: %n%n");
		
		System.out.printf("SANDUICHES:%n%n1 - X-Salada R$ 6,00%n2 - Bauru R$ 7,00%n3 - Minuano R$ 8,50%n4 - X-Bacon R$ 10,50%n5 - X-Calabresa R$ 12,00%n6 - X-Tudo R$ 17,00%n%n");
		...
		System.out.printf("MONTAVEIS: %n%n");
		
		System.out.printf("PÃES:%n%n1 - Seda R$ 1,50%n2 - Bola R$ 1,50%n3 - Italiano R$ 2,50%n4 - 9 grãos R$ 2,50%n%n");
		System.out.printf("CARNES:%n%n1 - Carne em tiras%n2 - ");
